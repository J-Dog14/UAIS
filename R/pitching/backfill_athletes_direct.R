# Direct database insert script to backfill athletes
...
cat("\n")
cat("=", rep("=", 80), "\n", sep = "")
cat("*** DIRECT ATHLETE BACKFILL SCRIPT ***\n")
cat("=", rep("=", 80), "\n", sep = "")
cat("\n")
...
log_progress("Getting unique athlete UUIDs from f_kinematics_pitching...")
