# Quick script to backfill athletes from session.xml files (Hitting)
...
# ---------- Configuration ----------
DATA_ROOT <- Sys.getenv("HITTING_DATA_DIR", unset = "D:/Hitting/Data")  # Set to your hitting data directory path

# ---------- Main processing ----------
cat("\n")
cat("=", rep("=", 80), "\n", sep = "")
cat("*** HITTING ATHLETE BACKFILL SCRIPT ***\n")
cat("=", rep("=", 80), "\n", sep = "")
cat("\n")
