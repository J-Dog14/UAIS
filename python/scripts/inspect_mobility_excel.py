#!/usr/bin/env python3
"""
Inspect Mobility Assessment Excel File Structure
"""
...
print("=" * 80)
print("MOBILITY ASSESSMENT EXCEL FILE STRUCTURE")
print("=" * 80)
print()
...
try:
    ...
    output_path = Path(__file__).parent.parent.parent / "docs" / "mobility_excel_structure.json"
