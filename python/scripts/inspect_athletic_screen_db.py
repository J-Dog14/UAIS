#!/usr/bin/env python3
"""
Inspect Athletic Screen Database Structure
"""
...
print("=" * 80)
print("ATHLETIC SCREEN DATABASE STRUCTURE")
print("=" * 80)
print()
...
output_path = Path(__file__).parent.parent.parent / "docs" / "athletic_screen_db_structure.json"
