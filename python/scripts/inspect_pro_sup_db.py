#!/usr/bin/env python3
"""
Inspect Pro-Sup Database Structure
"""
...
db_path = Path(__file__).parent.parent / "proSupTest" / "pro-sup_data.sqlite"
...
print("=" * 80)
print("PRO-SUP DATABASE STRUCTURE")
print("=" * 80)
print()
...
output_path = Path(__file__).parent.parent.parent / "docs" / "pro_sup_db_structure.json"
