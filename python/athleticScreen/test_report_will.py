"""
Test script to generate PDF report for Will Saxenmeyer
"""
import sys
...
try:
    ...
    with conn.cursor() as cur:
        cur.execute("""
            ...
            WHERE LOWER(name) LIKE '%will%saxenmeyer%' OR LOWER(name) LIKE '%saxenmeyer%will%'
        ...
        if not result:
            print("Could not find Will Saxenmeyer in database")
        ...
        if not result:
            print("ERROR: Could not find Will Saxenmeyer")
            sys.exit(1)
